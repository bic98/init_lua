-- Neovim configuration packaged for the Windows installer.
--[[
...
require('lazy').setup({
  ...
  -- 메인 테마 (colorscheme 변경 시 자동 저장됨)
  {
    ...
    lazy = false,
    config = function()
      -- Keep runtime state outside the Git working tree.
      local colorscheme_file = vim.fn.stdpath 'state' .. '/init_lua/colorscheme.txt'
